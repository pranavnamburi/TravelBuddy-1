    ...
    <div class="form-container">
        ...
        <div class="form-inner">
            <form action="auth" class="login" method="POST">
                ...
                <p <% if ((Boolean)session.getAttribute("foundError") != null) { %> style="display:block; color: red;" <% } else { %> style="display:none; color: red;" <% } %>>Invalid email or password</p>
                <% session.removeAttribute("foundError"); %>
                <div class="field btn">
            ...
            <form action="reg" class="signup" method="POST">
                ...
                <div class="field">
                    <input type="email" name="alt_email" placeholder="Alternate Email" required>
                </div>
                <div class="field">
